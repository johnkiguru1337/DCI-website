    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-gray-500 sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <header class="font-semibold bg-gray-500 text-gray-200 py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md">
                    <?php echo e(__('Login')); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <a class="text-sm text-blue-400 hover:text-blue-300 whitespace-no-wrap no-underline hover:underline ml-auto"
                    ...
                    <div class="flex flex-wrap">
                        <button type="submit"
                        class="w-full select-none font-bold whitespace-no-wrap p-3 rounded-lg text-base leading-normal no-underline text-gray-100 bg-gray-400 hover:bg-gray-700 sm:py-4">
                            <?php echo e(__('Login')); ?>
                        ...
                        <p class="w-full text-xs text-center text-gray-200 my-6 sm:text-sm sm:my-8">
                            ...
                            <a class="text-blue-400 hover:text-blue-300 no-underline hover:underline" href="<?php echo e(route('register')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jonte/laravelp/dci/resources/views/auth/login.blade.php ENDPATH**/ ?>