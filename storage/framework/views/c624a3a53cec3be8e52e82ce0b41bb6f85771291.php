    ...
    <div class="m-auto w-4/6 py-7 bg-gradient-to-r from-gray-800 to-gray-500 rounded-md">
        ...
        <div class="text-center ">
            <h1 class="text-xl capitalize italic text-blue-300">
                you are editing Crime id=<?php echo e($crime->crime_id); ?>,name= <?php echo e($crime->officer_id); ?>

            </h1>
        </div>
        <div class="flex justify-center pt-20">
            <form action="/crime/<?php echo e($crime->crime_id); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                    <div class="block">
                        <label for="crimeid">Enter crime new modified id</label>
                        <input type="text"
                        class="block shadow-5xl mb-2 p-2 w-80 italic placeholder-gray-400"
                        name="officerid" value=" <?php echo e($crime->crime_id); ?> ">
