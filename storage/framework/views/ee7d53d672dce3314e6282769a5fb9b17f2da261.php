        ...
        <div class="flex p-3 bg-gradient-to-r from-gray-900 to-gray-600 ">
            <div class="flex-1">
                <h1 class="uppercase text-gray-400 text-3xl text-center underline">
                    ...
                    src="<?php echo e(asset('images/commander.webp')); ?>" alt="" srcset="">
            </div>
            <div class="flex-1">
                <h1 class="uppercase text-gray-400 text-3xl text-center underline">
                    leutenant</h1>
                    <img class="p-2 rounded m-4"
                    src="<?php echo e(asset('images/aasa.jpg')); ?>" alt="" srcset="">
            </div>
            <div class="flex-1">
                <h1 class="uppercase text-gray-400 text-3xl text-center underline">
                    major</h1>
                    <img class="p-2 rounded m-4"
                    src="<?php echo e(asset('images/major].webp')); ?>" alt="" srcset="">
            </div>
        </div>
        ...
        <div class="flex p-3 bg-gradient-to-r from-gray-900 to-gray-600 ">
            ...
            <div class="flex-1">
                <h1 class="uppercase text-gray-400 text-3xl text-center underline">
                     commander</h1>
                    <img class="p-2 rounded m-4"
                    src="<?php echo e(asset('images/helicopter.webp')); ?>" alt="" srcset="">
            </div>
            <div class="flex-1">
                <h1 class="uppercase text-gray-400 text-3xl text-center underline">
                    leutenant</h1>
                    <img class="p-2 rounded m-4"
                    src="<?php echo e(asset('images/jet.webp')); ?>" alt="" srcset="">
            </div>
            <div class="flex-1">
                <h1 class="uppercase text-gray-400 text-3xl text-center underline">
                    major</h1>
                    <img class="p-2 rounded m-4"
                    src="<?php echo e(asset('images/rocket.webp')); ?>" alt="" srcset="">
            </div>
        </div>
        <h1 class="uppercase text-gray-500 text-5xl text-center mt-3 mb-3">
            services</h1>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jonte/laravelp/dci/resources/views/home.blade.php ENDPATH**/ ?>